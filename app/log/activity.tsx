...
import { ActivityTrendChart } from '../../src/features/log/components/ActivityTrendChart';
import { LOG_PRIMARY_COLOR } from '../../src/features/log/constants';
import { syncedMetrics, todayActivities, yesterdayActivities } from '../../src/features/log/mockData';

export default function ActivityScreen(): ReactElement {
  return (
    <LogLayout activeTab="activity">
